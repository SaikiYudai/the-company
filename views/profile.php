            ...
            <div class="col-8">
                <div class="card my-5">
                    <div class="card-header">
                        <img src="../images/<?=$user_data['photo']?>" alt="<?=$user_data['username']?>" class="img-thumbnail">
                    </div>
                    <form action="../actions/upload-photo.php" method="post" class="card-body" enctype="multipart/form-data">
                        ...
                        <input type="file" name="photo" id="photp" class="form-control">
                        ...
                        <h5 class="h4 mt-4"><?=$user_data['username']?></h3>
